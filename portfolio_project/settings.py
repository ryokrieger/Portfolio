...
# ── Server-side API cache TTLs ──────────────────────────────────────────────────
GITHUB_CACHE_TTL_SECONDS = int(os.environ.get("GITHUB_CACHE_TTL_SECONDS"))
CODEFORCES_CACHE_TTL_SECONDS = int(os.environ.get("CODEFORCES_CACHE_TTL_SECONDS"))